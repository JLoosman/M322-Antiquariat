    ...
    <section class="modal">
        <div class="modal-frame">
            ...
            <form action="">
                ...
                <div>
                    <input type="text" placeholder="Kategorie..." name="kategorie">
                    <input type="text" placeholder="Katalog..." name="katalog">
                </div>
                <div>
    ...
    <section>
        <div class="search">
            <div class="search-left">
                ...
                <svg onclick="alert('click')" width="36" height="40" viewBox="0 0 36 40" fill="none" xmlns="http://www.w3.org/2000/svg">
